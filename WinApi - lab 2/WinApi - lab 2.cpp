// WinApi - lab 2.cpp : Определяет точку входа для приложения.
//

#include "pch.h"
#include "framework.h"
#include "WinApi - lab 2.h"

#define MAX_LOADSTRING 100



INT_PTR CALLBACK StringList(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    WCHAR str[300];
    int index;
    switch (message)
    ...
    case WM_COMMAND:
        ...
        case IDC_PLUS_BUTTON:
            GetDlgItemText(hDlg, IDC_INPUT, str, 300);
            SendDlgItemMessage(hDlg, IDC_LIST, LB_ADDSTRING, NULL, (LPARAM)str);
            break;
        case IDC_MINUS_BUTTON:
            index = SendDlgItemMessage(hDlg, IDC_LIST, LB_GETCURSEL, NULL, NULL);
            SendDlgItemMessage(hDlg, IDC_LIST, LB_DELETESTRING, (WPARAM)index, NULL);
            break;
        case IDC_C_BUTTON:
    ...
    case WM_COMMAND:
        {
            ...
            {
            case ID_STRING_LIST:
                DialogBox(hInst, MAKEINTRESOURCE(IDD_DIALOG1), hWnd, StringList);
                break;
            case IDM_ABOUT:
